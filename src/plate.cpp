...
std::vector<Yolo::Detection> PlateDet::doInference(cv::Mat &img) {
    result.clear();
...
void PlateDet::preprocessImage(const cv::Mat &img, float *imgBufferArray) {
...
void PlateDet::createContextExecution() {
