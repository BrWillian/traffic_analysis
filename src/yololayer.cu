...
namespace nvinfer1
{
    ...
    int YoloLayerPlugin::getNbOutputs() const TRT_NOEXCEPT
    {
        return 1;
    }
    ...
    void YoloPluginCreator::setPluginNamespace(const char *libNamespace)  TRT_NOEXCEPT
    {
        mNamespace = libNamespace;
    }
    const char* YoloPluginCreator::getPluginNamespace()const TRT_NOEXCEPT
    {
