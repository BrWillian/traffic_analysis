...
std::vector<Yolo::Detection> OcrDet::doInference(cv::Mat &img) {
    result.clear();
...
void OcrDet::preprocessImage(const cv::Mat &img, float *imgBufferArray) {
...
void OcrDet::createContextExecution() {
